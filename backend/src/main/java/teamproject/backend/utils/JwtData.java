...
public class JwtData {
    ...
    public static final long REFRESH_COOKIE_EXPIRE_SECOND = Duration.ofDays(30).toSeconds();
    public static final long ACCESS_COOKIE_EXPIRE_SECOND = Duration.ofHours(1).toSeconds();
}
