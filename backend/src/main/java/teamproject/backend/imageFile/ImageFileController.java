...
public class ImageFileController {
    ...
    @GetMapping("/image")
    public BaseResponse<ImageFileResponse> imageFileDownload(@RequestParam String image_name) throws MalformedURLException {
        return new BaseResponse<>("사진을 불러왔습니다.",imageFileService.findByFileName(image_name));
    }
}
